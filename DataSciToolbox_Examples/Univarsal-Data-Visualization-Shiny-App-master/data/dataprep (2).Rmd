...
unemployed_total <- unemployed_total %>% rename(unemployed = value)


labor_force <- creat_tib_from_json(json, 2) 

labor_force <- labor_force %>% rename("labor.force" = value)
...
```{r}
unemployed_labor_force <- left_join(unemployed_total, labor_force)
write_csv(unemployed_labor_force, 'unemployed_labor_force.csv')
...
```{r}
labor_force %>% write_csv('labor_force.csv')
labor_force
```
